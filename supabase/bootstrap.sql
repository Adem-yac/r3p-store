-- Exécuter UNE FOIS : https://supabase.com/dashboard/project/cjonwneuqwcyoklezixt/sql/new
...
-- Seed automatique du catalogue (boutique + site public)
...
-- Compte admin (après création user dans Auth → Users) :
